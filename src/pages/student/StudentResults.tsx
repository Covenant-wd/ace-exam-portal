...
export default function StudentResults() {
  ...
  useEffect(() => {
    supabase
      ...
      .then(({ data }) => {
        // Theory exams are display-only — students write answers on paper so
        // there is no score to show. Exclude them from results entirely.
  ...
  return (
    <div>
      ...
      {results.length === 0 ? (
        <p className="text-muted-foreground">You haven't completed any MCQ exams yet.</p>
      ) : (
